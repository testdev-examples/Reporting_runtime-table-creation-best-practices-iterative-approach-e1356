...
'ORIGINAL LINE: this.button1.Click += new System.EventHandler(this.createReportWithTableInCode_Click);
			' 
			' button2
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.button2.Click += new System.EventHandler(this.createReportInCodeAndAddTableOnEvent_Click);
			' 
			' Form1
			' 
